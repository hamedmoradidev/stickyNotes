...
export default function ContactMe() {
  return (
        <div id="aboutMe" class="hidden lg:flex flex-wrap w-[200px] h-[250px] justify-center items-center fixed left-2 bottom-2 bg-[#2d2d2d] gap-2 p-5 rounded-2xl text-white animate-bounce cursor-pointer">
